...
API_ID = int(os.environ.get("API_ID", "")) #Your API ID from my.telegram.org
...
DB_NAME = os.environ.get("DATABASE_NAME", "Filctore")
#--------------------------------------------
...
ABOUT_TXT = "<b><blockquote>◈ ᴄʀᴇᴀᴛᴏʀ: <a href=https://t.me/Heisenbergsells>Heisenberg</a>\n◈ ꜰᴏᴜɴᴅᴇʀ ᴏꜰ : <a href=https://t.me/Heisenberg_Universe> Heisenberg Universe</a>\n◈ Backup : <a href=https://t.me/HeisenbergBackupZone>Heisenberg Backup</a></blockquote></b>"
#--------------------------------------------
#--------------------------------------------
